        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-neutral-900 mb-6">
              Trouve exactement où ton funnel
              <br />
              <span className="text-blue-600">perd de l'argent</span>
            </h1>
            <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
              J'analyse tes données pour identifier les 2-3 problèmes qui plombent
              tes conversions. Plan d'action clair, priorisé par impact.
            </p>
          </FadeIn>
        </div>
      </section>
