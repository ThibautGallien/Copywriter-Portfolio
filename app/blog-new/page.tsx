...
export default function BlogPage() {
  ...
  const allCategories = [
    "Tous",
    ...Array.from(
      new Set(sortedPosts.flatMap((post) => post.categories))
    ),
  ];
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  !searchTerm
                    ...
                    <ClickableArticleCard key={post.slug} post={post} />
                  ))}
                </div>
              </div>
            </FadeIn>
                ...
                <CardContent className="p-10 md:p-12 relative">
                  ...
                  <div className="relative z-10 text-center max-w-3xl mx-auto">
                    ...
                    >
                      <Link
                        href="/contact"
                        className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold px-8 py-4 rounded-full text-lg shadow-lg hover:shadow-xl transition-all"
                      >
