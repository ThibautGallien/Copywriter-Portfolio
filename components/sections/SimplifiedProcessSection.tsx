...
import { Search, Settings, TrendingUp, Calendar } from "lucide-react";
...
const steps = [
  {
    ...
    title: "Audit gratuit",
    description:
      "J'analyse votre stratégie email actuelle et identifie vos opportunités de croissance. Vous repartez avec un plan d'action concret, même si on ne travaille pas ensemble.",
    icon: Search,
  ...
  },
  {
    ...
    title: "Mise en place",
    description:
      "Je configure vos séquences email, optimise vos pages de capture et mets en place le tracking pour mesurer précisément les résultats.",
    icon: Settings,
...
export default function SimplifiedProcessSection() {
  return (
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-space-grotesk text-white mb-4 leading-tight">
            Comment je transforme votre liste en
            <br />
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Un processus simple, transparent et mesurable en 3 étapes
          </p>
        </motion.div>
